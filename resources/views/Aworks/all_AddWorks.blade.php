...
<!-- Add aworks Modal -->
<form id="aworks-form" action="{{ route('aworks.save') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal fade" id="create-aworks" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-body px-4">
                    <div class="row gy-2">
                        ...
                        <div class="col-xl-12">
                            ...
                            <input type="date" class="form-control" name="workDate" id="workDate" required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-success" id="submit-btn-aworks">Lưu</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                <table id="aworks-table" class="table table-bordered text-nowrap w-100">
                    <div id="buttons-container" class="d-flex justify-content-end gap-3">
                        ...
                        <button id="add-selected-btn" class="btn btn-success" style="border-radius: 7px;"
                            data-bs-toggle="modal" data-bs-target="#create-aworks">
                            <i class="fa fa-plus"></i>Tạo Công Việc
                        </button>
                    </div>
                    <thead>
                        <tr>
...
<script>
    $(document).ready(function() {
            ...
            var dataTable = $('#aworks-table').DataTable({
                "language": {
            ...
            $('#select-all-aworks').on('change', function() {
                var checked = $(this).prop('checked');
                $('#aworks-table tbody .form-check-input').each(function() {
            ...
            $('#aworks-table tbody').on('change', '.form-check-input', function() {
                var farmId = $(this).data('id');
                toggleButtons();
            ...
            $('#aworks-table').on('draw.dt', function() {
                $('#aworks-table tbody .form-check-input').each(function() {
                    var farmId = $(this).data('id');
            ...
            //     var selectedRows = $('#aworks-table tbody .form-check-input:checked');
            ...
            function toggleButtons() {
                var selected = $('#aworks-table tbody .form-check-input:checked').length;
                // if (selected > 0) {
