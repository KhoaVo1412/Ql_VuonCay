...
<div class="container-fluid">
    <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
        <h4 class="page-title fw-semibold fs-18 mb-0 padding">Danh Sách Đội</h4>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0 padding">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Trang Chủ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Danh Sách Đội</li>
                </ol>
            </nav>
        </div>
    </div>
...
<!-- Add teams Modal -->
<form id="teams-form" action="{{ route('teams.save') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal fade" id="create-teams" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Tạo Đội</h6>
                ...
                <div class="modal-body px-4">
                    <div class="row gy-2">
                        <!-- Tên -->
                        <div class="col-xl-12">
                            <label for="code" class="form-label">Tên Tổ</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="submit-btn-teams">Lưu</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                <table id="teams-table" class="table table-bordered text-nowrap w-100">
                    <div id="buttons-container" class="d-flex justify-content-end gap-3">
                        ...
                        <button id="add-selected-btn" class="btn btn-success" style="border-radius: 7px;"
                            data-bs-toggle="modal" data-bs-target="#create-teams">
                            <i class="fa fa-plus"></i>Tạo Tổ
                        </button>
                    </div>
                    <thead>
                        <tr>
                            <th></th>
                            <th>
                                <input class="form-check-input check-all" type="checkbox" id="select-all-teams" value=""
                                    aria-label="...">
                            </th>
                            <th scope="col">Tổ</th>
                            {{-- <th scope="col">Tên</th> --}}
...
<script>
    $(document).ready(function() {
            ...
            $('#select-all-teams').on('change', function() {
                var checked = $(this).prop('checked');
                $('#teams-table tbody .form-check-input').each(function() {
            ...
            $('#teams-table tbody').on('change', '.form-check-input', function() {
                var farmId = $(this).data('id');
                toggleButtons();
            ...
            $('#teams-table').on('draw.dt', function() {
                $('#teams-table tbody .form-check-input').each(function() {
                    var farmId = $(this).data('id');
            ...
            //     var selectedRows = $('#teams-table tbody .form-check-input:checked');
            ...
            function toggleButtons() {
                var selected = $('#teams-table tbody .form-check-input:checked').length;
                // if (selected > 0) {
