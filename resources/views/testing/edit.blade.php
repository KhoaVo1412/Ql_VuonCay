    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('testing.update', $batch->id) }}" class="row">
            ...
            <div class="form-group col-lg-4">
                ...
                {{-- <input type="date" class="form-control" id="ngay_gui_mau" name="ngay_gui_mau"
                    value="{{$batch->testingResult->ngay_gui_mau}}" required> --}}
            ...
            <div id="svr" class="row">
                ...
                <div class="form-group col-lg-3 toggle-on-cv60 toggle-on-cv50">
                    ...
                    <input type="number" min="0" step="any" class="form-control" id="svr_viscous" name="svr_viscous"
                ...
                <div
                    ...
                    <select class="form-control" id="svr_color" name="svr_color">
                        ...
                        <option value="dacam" {{ old('svr_color', $batch->testingResult->svr_color) == 'dacam' ?
                            'selected' : '' }}>
                            Da
                            cam</option>
                        <option value="xanhlacaynhat" {{ old('svr_color', $batch->testingResult->svr_color) ==
                            'xanhlacaynhat' ? 'selected' : '' }}>
                            Xanh lá cây nhạt</option>
                        <option value="nau" {{ old('svr_color', $batch->testingResult->svr_color) == 'nau' ? 'selected'
                            : '' }}>
                            Nâu
                        </option>
                        <option value="do" {{ old('svr_color', $batch->testingResult->svr_color) == 'do' ? 'selected' :
                            '' }}>
                            Đỏ
                        </option>
                    </select>
                    <!-- <input type="number" min="0" step="any" class="form-control" id="svr_color" name="svr_color"
                                                                        value="{{ old('svr_color', $batch->testingResult->svr_color) }}" placeholder="Màu"> -->
                </div>
                <div class="form-group col-lg-3 toggle-on-3l">
