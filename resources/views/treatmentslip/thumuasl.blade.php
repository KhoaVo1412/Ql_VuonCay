                            ...
                            <div class="form-section">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-input" id="quantity" placeholder="Tên" min="1">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-input" id="quantity" placeholder="Nhà Cung Cấp"
                                            min="1">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Người Tạo</label>
                                        <input type="number" class="form-input" id="quantity" placeholder="Người Tạo"
                                            min="1">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Ngày Tạo</label>
                                        <input type="date" class="form-input" id="quantity" placeholder="Ngày Tạo"
                                            min="1">
                                    </div>
                                </div>
        ...
        newStep.innerHTML = `
            ...
            <div style="flex: 1;">
                <div class="form-row" style="margin-bottom: 0.5rem;">
                    ...
                    <div class="form-group">
                        <label class="form-label">Tên Phiếu</label>
                        <input type="text" class="form-input" id="quantity" placeholder="Tên" min="1">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Số Lượng</label>
                        <input type="number" class="form-input" name="treatmentDate">
