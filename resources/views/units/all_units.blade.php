...
<div class="container-fluid">
    <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
        <h5 class="page-title fw-semibold fs-18 mb-0">Danh Sách Đơn Vị Vật Tư</h5>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0 padding">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Trang Chủ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Danh Sách Đơn Vị Vật Tư</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Tạo Đơn Vị Vật Tư</h6>
                    ...
                    <div class="row gy-2">
                        {{-- <div class="col-xl-12">
                            ...
                            <select class="form-control" name="status" id="status">
                                <option value="Hoạt động">Chọn Danh Mục</option>
                                <option value="Không hoạt động">Không hoạt động</option>
                            </select>
                        </div> --}}
                        <div class="col-xl-12">
                            <label for="unit_name" class="form-label">Mã Đơn Vị Vật Tư</label>
                            <input type="text" class="form-control" name="code" required placeholder="Mã đơn vị">
                        </div>
                        <div class="col-xl-12">
                            <label for="unit_name" class="form-label">Tên Đơn Vị Vật Tư</label>
                ...
                <table id="units-table" class="table table-bordered text-nowrap w-100">
                    <div id="buttons-container" class="d-flex justify-content-end gap-2">
                        ...
                        <button id="add-selected-btn" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#create-units" style="border-radius: 30px;">
                            <i class="fa fa-plus"></i>Tạo Đơn Vị Vật Tư
                        </button>
                    </div>
                    <thead>
                        <tr>
                            ...
                            {{-- <th scope="col">STT</th> --}}
                            <th scope="col">Mã Đơn Vị Vật Tư</th>
                            <th scope="col">Tên Đơn Vị Vật Tư</th>
