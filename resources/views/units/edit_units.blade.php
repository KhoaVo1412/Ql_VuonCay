            ...
            <form id="form-units" action="{{ route('units.update', ['id' => $units->id]) }}" method="POST"
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="code" class="form-label">Mã Đơn Vị Vật Tư</label>
                                <input type="text" class="form-control" name="code" placeholder="Tên"
                                    value="{{ $units->code }}" required>
                            </div>
                            <div class="col-md-4">
                                <label for="name" class="form-label">Tên Đơn Vị Vật Tư</label>
