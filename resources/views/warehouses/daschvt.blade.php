...
<div class="container-fluid">
    <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
        <h4 class="page-title fw-semibold fs-18 mb-0">Vật Tư</h4>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Thêm Vật Tư</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-4">
                    <div class="row gy-2">
                        <div class="col-xl-12">
                            <label for="warehouse_code" class="form-label">Mã Vật Tư</label>
                            <input type="text" class="form-control" name="warehouse_code" id="warehouse_code" required
                                placeholder="Mã kho">
                        </div>
                        <div class="col-xl-12">
                            <label for="warehouse" class="form-label">Tên Vật Tư</label>
                            <input type="text" class="form-control" name="warehouse" id="warehouse" required
                                placeholder="Tên kho">
                        </div>
                        <div class="col-xl-12">
                            <label for="warehouse" class="form-label">Danh Mục</label>
                            <input type="text" class="form-control" name="warehouse" id="warehouse" required
                                placeholder="Danh mục">
                        </div>
                        <div class="col-xl-12">
                            <label for="warehouse" class="form-label">Đơn Vị</label>
                            <input type="text" class="form-control" name="warehouse" id="warehouse" required
                                placeholder="Đơn Vị">
                        </div>
                        <div class="col-xl-12">
                            <label for="warehouse" class="form-label">Loại Đơn Vị</label>
                            <input type="text" class="form-control" name="warehouse" id="warehouse" required
    ...
    $(document).ready(function() {
            ...
            var dataTable = $('#warehouses-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'action', n ame: 'action', orderable: false, searchable: false }
                ],
