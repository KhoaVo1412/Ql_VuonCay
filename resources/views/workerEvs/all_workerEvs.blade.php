...
<div class="container-fluid">
    <div class="d-md-flex d-block align-items-center justify-content-between my-2 page-header-breadcrumb">
        <h5 class="page-title fw-semibold mb-0 padding">Quản Lý Đánh Giá</h5>
...
<!-- Add workerevs Modal -->
<form id="workerevs-form" action="{{ route('workerevs.save') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="modal fade" id="create-workerevs" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Thêm Đánh Giá</h6>
                    ...
                    <div class="row gy-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label class="form-label required">Mã Đánh Giá</label>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label class="form-label required">Tên Đánh Giá</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="submit-btn-workerevs">Lưu</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card custom-card">
            {{-- <div
                ...
                <button class="btn btn-sm btn-success btn-wave waves-light" data-bs-toggle="modal"
                    data-bs-target="#create-workerevs">
                ...
                <div class="card-content">
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            {{-- <div class="form-group">
                                <label class="form-label">Tên Đánh Giá</label>
            ...
            <div class="card-content">
                ...
                <div class="card-body">
                    <table id="workerevs-table" class="table table-bordered text-nowrap w-100">
                        <div id="buttons-container" class="d-flex justify-content-end gap-2">
                            ...
                            <button id="add-selected-btn" class="btn btn-success" style="border-radius: 7px;">
                                <a href="{{route('workerevs.add')}}" class="text-white"><i class="fa fa-plus"></i>Thêm
                                    Đánh Giá</a>
                            </button>
                        </div>
                        <thead>
                            <tr>
                                <th></th>
                                <th>
                                    <input class="form-check-input check-all" type="checkbox" id="select-all-workerevs"
                                        value="" aria-label="...">
                                </th>
                                {{-- <th scope="col">STT</th> --}}
                                <th scope="col">Mã</th>
...
<script>
    $(document).ready(function() {
            ...
            var dataTable = $('#workerevs-table').DataTable({
                // "language": {
            ...
            $('#select-all-workerevs').on('change', function() {
                var checked = $(this).prop('checked');
                $('#workerevs-table tbody .form-check-input').each(function() {
            ...
            $('#workerevs-table tbody').on('change', '.form-check-input', function() {
                var workId = $(this).data('id');
                toggleButtons();
            ...
            $('#workerevs-table').on('draw.dt', function() {
                $('#workerevs-table tbody .form-check-input').each(function() {
                    var workId = $(this).data('id');
            ...
            function toggleButtons() {
                var selected = $('#workerevs-table tbody .form-check-input:checked').length;
                // if (selected > 0) {
